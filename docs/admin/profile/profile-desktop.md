Your virtual subject has been set up, and you'll now access your personal CGMSIM Profile, in which many parameters must be selected before the simulation can start.
